...
class GeographyRuleTest {
    ...
    void do_not_throw_when_countryConstraints_is_not_null() {
        ...
        var countrySpecifications    = Set.of(new CountrySpecification(new CountryCode("no"), postalCodeSpecifications));
    ...
    void isSatisfiedBy_should_throw_when_query_is_null() {
        var countryConstraints = Set.of(new CountrySpecification(new CountryCode("no"), new HashSet<>()));
